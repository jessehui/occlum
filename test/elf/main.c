...
// //void pre_main2() __attribute__ ((section (".init_array")));

void pre_main() {
    printf("Runs before main!\n");
}

// void __attribute__ ((section (".init_array"))) pre_main2() {
void __attribute__((constructor)) pre_main2() {
    printf("Runs before main! - 2 \n");
}

void __attribute__((destructor)) after_main2() {
    printf("Runs after main! - 2 \n");
}
